    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'persetujuan',
            'url'  => 'prstjuan',
            'icon' => 'fas fa fa-th-large',
            'permission' => 'admin',

        ],

        [
            'text' => 'Input Barang Masuk',
            'url'  => 'itemdetail',
            'icon' => 'fas fa fa-download',
            'permission' => 'create-input-barang',
        ],
         [
            'text' => 'Laporan',
            'url'  => 'laporan',
            'icon' => 'fas fa fa-download',
            'permission' => 'laporan-kpk',
        ],
